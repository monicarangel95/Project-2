    ...
    return (
        <div>
            <section id="photos" className="container section" style={{ marginTop: "30px" }}>
                ...
                <div className="row">
                    <div className="col s12 l4 push-l1 xl4 push-xl1">
                        <img src={artist} alt="Artist on Stage" className="responsive-img z-depth-2" />
                    </div>
                    <div className="col s12 m6 l6 xl 3 offset-l1">
                ...
                <div className="row">
                    <div className="col s12 l4 push-l7 xl4 push-xl7">
                        <img src={events} alt="Concert Event" className="responsive-img z-depth-2" />
                    </div>
                    <div className="col s12 l6 pull-l4 offset-l1">
